...
export const fullBodyTemplates: WorkoutTemplate[] = [
  // ── 4 · Full Body ──────────────────────────────────────────────────────────
  {
    ...
    supersets: [
      { e1: jumpingJacks, e2: [mountainClimberWalks, highKnees] },
      {
  ...
  // ── 8 · Full Body ──────────────────────────────────────────────────────────
  {
    ...
    supersets: [
      ...
      { e1: jumpingJacks, e2: calfRaises },
      { e1: lunges, e2: [mountainClimberWalks, highKnees] },
    ],
    lvl2Extra: { e1: [kneelingPushUps, pushUps], e2: plankShoulderTaps },
    lvl3Extra: { e1: shadowBoxing, e2: squatJumps },
    cooldowns: [
  ...
  // ── 12 · Full Body ─────────────────────────────────────────────────────────
  {
    ...
    supersets: [
      { e1: [mountainClimberWalks, highKnees], e2: lunges },
      { e1: jumpingJacks, e2: calfRaises },
  ...
  // ── 16 · Full Body ─────────────────────────────────────────────────────────
  {
    ...
    supersets: [
      ...
      { e1: [mountainClimberWalks, highKnees], e2: reverseLunges },
      { e1: jumpingJacks, e2: lunges },
    ],
    lvl2Extra: { e1: [kneelingPushUps, pushUps], e2: plankShoulderTaps },
    lvl3Extra: { e1: shadowBoxing, e2: squatJumps },
    cooldowns: [
  ...
  // ── 20 · Full Body ─────────────────────────────────────────────────────────
  {
    ...
    supersets: [
      ...
      { e1: [jumpingJacks, highKnees], e2: lunges },
    ],
  ...
  // ── 28 · Full Body ─────────────────────────────────────────────────────────
  {
    ...
    supersets: [
      ...
      { e1: [squats, squatJumps], e2: jumpingJacks },
