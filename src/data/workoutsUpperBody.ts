...
export const upperBodyTemplates: WorkoutTemplate[] = [
  // ── 2 · Upper Body ─────────────────────────────────────────────────────────
  {
    ...
    lvl2Extra: { e1: wavePushUps, e2: plankWalkOuts },
  ...
  // ── 6 · Upper Body ─────────────────────────────────────────────────────────
  {
    ...
    lvl3Extra: { e1: shoulderTapPushUps, e2: downwardDogPushUps },
  ...
  // ── 10 · Upper Body ────────────────────────────────────────────────────────
  {
    ...
    lvl2Extra: { e1: plankShoulderTaps, e2: plankWalkOuts },
    lvl3Extra: { e1: shoulderTapPushUps, e2: tableTopDips },
    cooldowns: [chestStretch, tricepStretch, upperBackStretch, ...COOLDOWN_END],
  },
  ...
  // ── 22 · Upper Body ────────────────────────────────────────────────────────
  {
    ...
    lvl2Extra: { e1: airplanePushUps, e2: plankWalkOuts },
