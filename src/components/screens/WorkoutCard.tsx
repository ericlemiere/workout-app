...
const tagColors: Record<string, string> = {
  "lower body": "text-electric-cyan bg-electric-cyan/10",
  "upper body": "text-electric-green bg-electric-green/10",
  core: "text-electric-violet bg-electric-violet/10",
  "full body": "text-lime bg-lime/10",
};
      ...
      <Link href={`/workout/${workout.id}`} className="block">
        <div className="bg-charcoal/60 border border-slate-700/50 rounded-2xl overflow-hidden active:bg-charcoal">
          <div className="relative h-40">
            ...
            {completedCount > 0 && (
              <div className="absolute top-3 right-3 bg-electric-green/90 backdrop-blur-sm rounded-full px-2 py-0.5 flex items-center gap-1">
